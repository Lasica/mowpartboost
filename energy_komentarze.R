...
# funkcja predykcji
# ewaluacja rozwiazania przez zbior testowy/cross validation
## *ingerencja w rpart zeby uzyc logartym wiarygodnosci
# zbadac rozne metody budowania drzewa - parametry rpart
# lepszy wskaznik ewaluacji - r kwadrat?
# zbadac temat nadmiernego dopasowania w gradient boostingu
